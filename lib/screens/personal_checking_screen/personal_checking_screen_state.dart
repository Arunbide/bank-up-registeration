...
class PersonalCheckingScreenState extends State<PersonalCheckingScreen> {
  ...
  Future<Position?> getUserLocation() async {
    ...
    var status = prefs.getBool('LOCATION_ACCESS_GRANTED');
                                                          ...
                                                          Row(
                                                            children: [
                                                              IconButton(
                                                                ...
                                                                onPressed: () {
                                                                  String appStoreLink = ''; // Add your App Store link here
                                                                  String playStoreLink = 'https://play.google.com/store/apps/details?id=com.swiftsol.bankup';

                                                                  String linkToShare;

                                                                  if (Theme.of(context).platform == TargetPlatform.iOS) {
                                                                    // iOS (App Store)
                                                                    linkToShare = appStoreLink;
                                                                  } else if (Theme.of(context).platform == TargetPlatform.android) {
                                                                    // Android (Play Store)
                                                                    linkToShare = playStoreLink;
                                                                  } else {
                                                                    linkToShare = 'https://play.google.com/store/apps/details?id=com.swiftsol.bankup';
                                                                  }

                                                                  Share.share('Check out this app on the store: $linkToShare');
                                                                },
                                                              ),
